...
The Delivery Bottleneck (Logistics Funnel): Identify which states experience the most significant delivery variances (actual vs. estimated) and evaluate how these systemic delivery buffers impact average customer review scores.

Freight Friction: Analyze how logistical freight costs scale relative to the actual price of products across different geographical states to uncover margin-eating shipping burdens.

Seller Performance Matrix: Segment the marketplace seller base into four distinct revenue tiers (quartiles) to identify top performers and underperforming accounts.

🔍 Analytical Methodology
To address these business problems, the analysis was broken down into three distinct SQL workflows (available in the queries/ directory):

Scenario 1: Delivery Delays Analysis (Reference: 01_The_Delivery_Bottleneck.sql)
...
Scenario 2: Freight Costs Ratio Analysis (Reference: 02_The_Freight_Ratio.sql)
...
Scenario 3: Seller Performance Matrix (Reference: 03_The_Seller_Performance_Matrix.sql)
...
Logistics & Customer Satisfaction: Shift operational focus toward product quality control and accurate tracking rather than merely accelerating shipments. The data clearly shows that beating bloated delivery estimates by 20 days does not guarantee 5-star reviews.
